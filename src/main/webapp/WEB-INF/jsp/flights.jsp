...
<nav aria-label="Flights pagination">
    ...
    <ul class="pagination justify-content-center">
        ...
        <c:if test="${param.page gt 1}">
            <li class="page-item">
                <a class="page-link" href="http://localhost:8080/controller?command=all-flights&page=${param.page - 1}"
                   tabindex="-1">
        ...
        <c:if test="${param.page gt 1}">
            <li class="page-item"><a class="page-link"
                                     href="http://localhost:8080/controller?command=all-flights&page=${param.page - 1}">${param.page - 1}</a>
            </li>
        </c:if>
        <li class="page-item active">
            <a class="page-link"
               href="http://localhost:8080/controller?command=all-flights&page=${param.page}">${param.page}<span
        ...
        <li class="page-item">
            <a class="page-link"
               href="http://localhost:8080/controller?command=all-flights&page=${param.page + 1}">
